        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 rounded-lg space-y-3">
            <div className="flex justify-between">
              ...
              <span
                className={`font-semibold ${result.priceChange >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
                {result.priceChange >= 0 ? '+' : ''}
                {formatPercentage(result.priceChange / 100)}
              </span>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-red-600">{formatUSD(result.amount)}</span>
            </div>
          </div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg text-sm text-blue-800">
            ...
            <p>
              ...
              compared to when you deposited them. The loss is "impermanent" because it could be
              recovered if prices return to their original ratio.
            </p>
          </div>
        </div>
      )}
