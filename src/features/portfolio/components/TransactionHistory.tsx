          ...
          >
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <Badge
                  variant={tx.type === 'swap' ? 'info' : tx.type === 'send' ? 'warning' : 'success'}
                >
                  {tx.type}
                </Badge>
              ...
              <p className="text-sm mb-1">{tx.description || `${tx.type} transaction`}</p>
            ...
            <div className="text-right">
              {tx.valueUSD && <p className="font-semibold">{formatUSD(tx.valueUSD)}</p>}
              <Badge
                variant={
