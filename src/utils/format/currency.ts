...
export function formatCurrencyAuto(
  ...
  if (absValue < 1) return formatCurrency(value, currency, { minimumFractionDigits: 4, maximumFractionDigits: 4 });
...
export function formatPrice(price: number, currency: Currency = 'USD'): string {
  ...
  if (price < 0.01) return formatCurrency(price, currency, { minimumFractionDigits: 6, maximumFractionDigits: 6 });
  if (price < 1) return formatCurrency(price, currency, { minimumFractionDigits: 4, maximumFractionDigits: 4 });
